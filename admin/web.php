        ...
        <div class="wrapper">
            <div class="row col-sm-12" style="padding-bottom: 15px;">
                <div class="dropdown">
                    ...
                    <li><a href="web.php">全部</a></li>
                    <?php require '../function/website_search.php';?>
                    </ul>
                </div>
            </div>
            <div class="row">
                    <div class="col-sm-12">
                        <section class="panel" style="margin-bottom:0;">
                            ...
                            <tbody>
                                <?php require '../function/website_detail.php'; ?>
                            </tbody>
                            </table>
                            <nav>
                              <ul class="pager"> 
                                <li>
                                  <a href="?cid=<?php echo $_GET['cid']; ?>&page=<?php echo $pageleft;?>" aria-label="Previous">
                                ...
                                <?php
                                    for ($i=1; $i <= $pagecount ; $i++) {
                                      if($i == $page){
                                        echo '<li><a style="color:#ffffff;background:#65CEA7;" href="?cid='.$_GET['cid'].'&page='.$i.'">'.$i.'</a></li>';
                                      }else{
                                        echo '<li><a href="?cid='.$_GET['cid'].'&page='.$i.'">'.$i.'</a></li>';
                                      }
                                    }
                                ?>
                                <li>
                                  <a href="?cid=<?php echo $_GET['cid']; ?>&page=<?php echo $pageright;?>" aria-label="Next">
