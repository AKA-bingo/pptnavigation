                            ...
                            <div class="panel-body">
                                <div role="form" class="form-horizontal adminex-form" >
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" placeholder="" id="cat_name" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">分类描述(选填)</label>
                                        <div class="col-lg-10">
                                            <input type="text" placeholder="" id="cat_memo" class="form-control">
                                    </div>
                                    </div>
                                    <div class="form-group" style="display: none;">
                                        <label class="col-lg-2 control-label">图片链接(选填)</label>
                                        <div class="col-lg-10">
                                            <input type="text" placeholder="" id="cat_icon" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">优先级(选填)</label>
                                        <div class="col-lg-10">
                                            <input type="text" placeholder="" id="cat_priority" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <button id="add_cat_btn" class="btn btn-primary" type="button">添加</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="../js/admin/cat_add.js"></script>
